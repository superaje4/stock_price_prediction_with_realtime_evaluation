...
def scrap_tambahan():
    ...
    try:
        ...
        undetect = selenium.webdriver.Chrome()
...
ali=gabung_data("AALI")
ali
# driver=selenium.webdriver.Chrome()
# driver.get("https://www.idx.co.id/primary/TradingSummary/GetStockSummary?length=9999&start=0&date=20240307")
# ali=gabung_data("AALI")
# def scrap_tambahan():
#     #buat fungsi iteratif
#     start_date = '2024-03-02'
